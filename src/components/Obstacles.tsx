...
const makeObstacles = (scene: Scene, groundY: number): Obstacle[] => {
  ...
  const configs: { x: number; w: number; h: number; type: string }[] = {
    forest: [
      { x: 550,  w: 55, h: 55, type: "log" },
      { x: 900,  w: 40, h: 65, type: "rock" },
      { x: 1300, w: 60, h: 50, type: "log" },
      { x: 1700, w: 45, h: 70, type: "rock" },
      { x: 2100, w: 55, h: 55, type: "log" },
      { x: 2550, w: 65, h: 45, type: "stump" },
      { x: 2950, w: 50, h: 65, type: "rock" },
      { x: 3300, w: 55, h: 55, type: "log" },
    ],
    underwater: [
      { x: 500,  w: 50, h: 60, type: "coral" },
      { x: 850,  w: 40, h: 70, type: "shell" },
      { x: 1250, w: 55, h: 55, type: "coral" },
      { x: 1650, w: 45, h: 65, type: "rock" },
      { x: 2050, w: 55, h: 60, type: "coral" },
      { x: 2450, w: 50, h: 70, type: "shell" },
      { x: 2850, w: 60, h: 55, type: "coral" },
      { x: 3250, w: 50, h: 65, type: "rock" },
    ],
    city: [
      { x: 480,  w: 50, h: 55, type: "barrel" },
      { x: 880,  w: 60, h: 50, type: "crate" },
      { x: 1280, w: 45, h: 65, type: "barrel" },
      { x: 1680, w: 60, h: 55, type: "crate" },
      { x: 2080, w: 50, h: 50, type: "barrel" },
      { x: 2480, w: 65, h: 45, type: "crate" },
      { x: 2880, w: 50, h: 65, type: "barrel" },
      { x: 3280, w: 60, h: 55, type: "crate" },
    ],
    moon: [
      { x: 520,  w: 55, h: 50, type: "moonrock" },
      { x: 920,  w: 45, h: 65, type: "crater" },
      { x: 1320, w: 60, h: 50, type: "moonrock" },
      { x: 1720, w: 50, h: 70, type: "crater" },
      { x: 2120, w: 55, h: 55, type: "moonrock" },
      { x: 2520, w: 65, h: 50, type: "crater" },
      { x: 2920, w: 55, h: 60, type: "moonrock" },
      { x: 3320, w: 50, h: 55, type: "crater" },
    ],
    space: [
      { x: 500,  w: 50, h: 60, type: "asteroid" },
      { x: 900,  w: 60, h: 55, type: "crate" },
      { x: 1300, w: 50, h: 65, type: "asteroid" },
      { x: 1700, w: 60, h: 55, type: "crate" },
      { x: 2100, w: 55, h: 60, type: "asteroid" },
      { x: 2500, w: 65, h: 50, type: "crate" },
      { x: 2900, w: 55, h: 65, type: "asteroid" },
      { x: 3300, w: 60, h: 55, type: "crate" },
    ],
  }[scene];
